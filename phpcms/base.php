...
define('JS_PATH',pc_base::load_config('system','js_path'));//js 路径
define('CSS_PATH',pc_base::load_config('system','css_path'));//css 路径
define('JS_PATH_CDN',pc_base::load_config('system','js_path_cdn'));
define('CSS_PATH_CDN',pc_base::load_config('system','css_path_cdn'));
define('CDN_CSS',pc_base::load_config('system','cdn_css'));
define('CDN_JQUERY',pc_base::load_config('system','cdn_jquery'));
//img 路径
