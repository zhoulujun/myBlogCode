...
<?php echo $string;?>
  	...
  	<tr>
		<td>选择全部栏目</td>
		<td><input type="button" value="选择全部" id="selectAll"/></td>
	</tr>
  	<tr>
  	...
  	<tr>
	    ...
	    <td colspan=3><input type=text name="email" value="zhoulujun@live.cn" size=20></td>
  	</tr>
  	<tr>
...
<script type="text/javascript">
	document.getElementById("selectAll").onclick=function(){
		var options=document.getElementById("catids").options;
