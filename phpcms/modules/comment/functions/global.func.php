...
function direction($direction) {
	switch($direction){
		case 1:
			return '<label class="label-pos btn btn-success">正</label>';
		break;
		case 2:
			return '<label class="label-pos btn btn-success">反</label>';
		break;
		case 3:
			return '<label class="label-pos btn btn-success">中</label>';
		break;
	}
}
