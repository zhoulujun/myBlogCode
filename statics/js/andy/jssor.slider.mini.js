...
$(function () {
    ...
    if(document.getElementById("slider_category")){
        var optionsCategory = {
            $AutoPlay: true,
        ...
        var slider_category = new $JssorSlider$("slider_category", optionsCategory);

    }


    if(document.getElementById("slider2_container")){
        var options2 = {
            $AutoPlay: true,
            $AutoPlaySteps: 1,
            $AutoPlayInterval: 0,
    ...
    if(document.getElementById("slider_header")){
        var options_slider_header = {
            $AutoPlay: true,
            $AutoPlaySteps: 1,
            ...
            $SlideDuration: 600,
            $MinDragOffsetToSlide: 20,
            $SlideWidth: $("#slider_header").outerWidth(),
            $SlideSpacing: 0,
            $DisplayPieces: 1,
            $ParkingPosition: 0,
            $UISearchMode: 1,
        ...
        var slider_header = new $JssorSlider$("slider_header", options_slider_header);
    }
